...
export default function LikeDislikePage( {name,desc} ){
    ...
    function dislikeButton(){
        ...
        <View style={styles.appContainer}>
             <ImageBackground style={{justifyContent:'space-around',alignItems:'center', width:'100%', height:'100%'}} source={require ('../assets/starry_sky.png')} >
                 <View>
                 <View style={{flexDirection:'row',borderRadius:10, justifyContent:'space-around',borderWidth:1,padding:10, alignItems:'center',backgroundColor:'#FFC0CB'}}>
                        <View>
                            <Image source={require('../assets/furry.jpg')} style={{borderRadius:5, width:100,height:100}} />
                        </View>  
                ...
                <Text style={{fontSize:20, color:'black'}}>{name}</Text>
                    ...
                    <Text style={{fontSize:36, textAlign:'center',color:'white', fontWeight:'bold', color: '#FFC0CB'}} >{likes}</Text>
                 </View>
